...
const Contact = () => {
  ...
  return <section id="contato" className="py-12 sm:py-16 md:py-20 bg-muted/30">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
              ...
              <div className="bg-white rounded-xl p-6 shadow-soft hover:shadow-medium transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+551125897600" className="text-muted-foreground hover:text-primary transition-colors">
                      (11) 2589-7600
                    </a>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-soft hover:shadow-medium transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:leonardo@globalkey.com.br" className="text-muted-foreground hover:text-primary transition-colors break-all">
            ...
            <div className="bg-gradient-primary rounded-xl md:rounded-2xl p-6 sm:p-8 text-white flex flex-col justify-center">
              ...
              <Button asChild size="lg" className="bg-white text-primary hover:bg-white/90 w-full mb-6">
              ...
              <div className="border-t border-white/20 pt-6 mt-2">
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/fibra_kapton_global_key/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all" aria-label="Instagram">
                    <Instagram className="w-6 h-6" />
                  </a>
                  <a href="https://www.facebook.com/fibra.kapton.globalkey" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all" aria-label="Facebook">
